...
export default function GrantsPage() {
  return (
    <main className="bg-background min-h-screen">
      <PageMeta
        title="Grants"
        description="Distribute grants with milestone-based releases, multi-signer approvals, and public accountability on Bitcoin Cash."
        path="/grants"
      />
      {/* Navigation */}
      ...
      <section className="pt-32 pb-16 px-6 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <a href="https://docs.flowguard.cash/concepts/grants" target="_blank" rel="noopener noreferrer">
