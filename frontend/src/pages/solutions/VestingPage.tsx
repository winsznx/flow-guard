...
import { ArrowRight, Lock, Calendar, Shield, TrendingUp, Users } from 'lucide-react';
      ...
      <section className="pt-32 pb-16 px-6 lg:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm font-medium text-accent">Token Vesting</span>
          </motion.div>
          ...
          >
            Release tokens on a schedule that can't be changed
          </motion.h1>
        ...
        <div className="py-12 md:py-20">
          {[
            ...
            },
            {
              ...
              description: 'Cancel vesting early if needed.',
              detail: 'Unvested funds automatically return to the treasury.',
            },
            {
              icon: TrendingUp,
              title: 'Live tracking',
              description: 'Recipients see exactly how much has vested.',
              detail: 'Track when the next unlock happens in real-time.',
            },
            {
              icon: Users,
              title: 'Multiple recipients',
              description: 'Create vesting schedules for investors, team members, and advisors.',
              detail: 'Manage everything from one treasury.',
            },
            {
              icon: Lock,
              title: 'No early withdrawal',
              description: 'Recipients can only withdraw what has vested.',
              detail: 'Locked funds stay in the contract.',
            },
            {
              icon: ArrowRight,
              title: 'Works with tokens',
              description: 'Vest BCH or CashTokens.',
              detail: 'All the same rules apply.',
            },
          ].map((item, index) => {
      ...
      <section className="py-20 px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              {
                title: 'Investor token unlocks',
                description: 'Set 1-year cliffs and 4-year vesting for early investors. Unlock 25% each year.',
              },
              {
                title: 'Team compensation',
                description: 'Vest team tokens monthly over 2-3 years. Cancel if someone leaves early.',
              },
              {
                title: 'Advisor agreements',
                description: 'Lock advisor allocations with quarterly unlocks. Track all agreements in one place.',
              },
            ].map((useCase, index) => (
              <motion.div
                key={index}
