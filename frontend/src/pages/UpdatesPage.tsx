...
const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    date: '2026-02-17',
    summary:
      'Most BCH teams manage treasury with shared wallets and verbal rules. As treasury size grows, the risks grow with it. Treasury rules should be enforced by the blockchain, not by memory or trust.',
  ...
  },
  {
    ...
    date: '2026-02-15',
    summary:
      'Introducing FlowGuard: BCH-native treasuries, streams, payments, distributions, and governance with contract-backed execution on Bitcoin Cash Chipnet.',
  ...
  },
  {
    ...
    date: '2026-02-10',
    summary:
      'Manual treasury and payout operations are error-prone and hard to audit. Learn how FlowGuard moves those rules on-chain with contract-backed execution.',
...
export default function UpdatesPage() {
  ...
  return (
    <main className="bg-background min-h-screen">
      <PageMeta
        title="Updates"
        description="Product updates, technical breakdowns, launch notes, and BCH-native treasury research from the FlowGuard team."
        path="/updates"
      />
      {/* Hero */}
          ...
          <Link to={`/updates/${featuredPost.slug}`} className="block mb-16 group">
            <div className="bg-surface border border-border rounded-2xl overflow-hidden hover:border-primary/50 transition-all">
              ...
              <div className="p-8">
                ...
                <p className="text-lg text-textSecondary mb-6">{featuredPost.summary}</p>
          ...
          {filteredPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-textSecondary mb-4 line-clamp-2">{post.summary}</p>
