      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li>
                  <a href={`${DOCS_SITE_URL}/reference/shared-types`} target="_blank" rel="noopener noreferrer" className="text-brand100 hover:text-white transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand300 rounded-sm">
                    SDK
                  </a>
                </li>
                <li>
                  <a href={`${DOCS_SITE_URL}/api/overview`} target="_blank" rel="noopener noreferrer" className="text-brand100 hover:text-white transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand300 rounded-sm">
                    API Reference
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href={`${DOCS_SITE_URL}/security`} target="_blank" rel="noopener noreferrer" className="text-brand100 hover:text-white transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand300 rounded-sm">
                    Security
                  </a>
                </li>
              </ul>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a href={`${DOCS_SITE_URL}/roadmap`} target="_blank" rel="noopener noreferrer" className="text-brand100 hover:text-white transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand300 rounded-sm">
                    Roadmap
                  </a>
                </li>
                <li>
        ...
        <div className="pt-8 border-t border-brand300/20 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            >
              <svg className="w-5 h-5" viewBox="0 0 1200 1227" fill="currentColor" aria-hidden="true">
            ...
            <a
              href="https://www.youtube.com/@flowguard_cash"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="text-brand100 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand300 rounded-sm p-1"
